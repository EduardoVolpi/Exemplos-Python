...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # -------------- Inicializa Outros Forms Aqui (depois é só usar o método .show())------------- #
    ...
    def btn_dialog_custom_clicked(self):
        ...
        # todo Exemplo de uso do to do, basta escrever a palavra como aqui no inicio
    ...
    def btn_input_double_clicked(self):
        ...
        if confirma:
            QMessageBox.information(
                self,
                "Titulo Aqui",
                f"Voce escolheu o número {digitado}",
            )
    ...
    def btn_renomear_ap_clicked(self):
        ...
        # A função rename() tamebm pode ser usada para mover um arquivo,
        # caso você informe um diretório diferente. Veja
    ...
    # ------------ Definição Funções Randomicas - usa "import random" ------------ #
...
if __name__ == "__main__":
    app = QApplication()
    app.setStyle("windowsvista")  # Windows - windowsvista - Fusion
